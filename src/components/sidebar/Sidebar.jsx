            ...
            <div className="px-2">
              <div className="py-4">
                <button
                  ...
                  className="cursor-pointer t group relative flex justify-center items-center rounded bg-white border-slate-300 border-[1px] px-2 py-1.5 text-slate-700"
                >
                  <div
              ...
              <ul className="space-y-2 flex flex-col border-t border-slate-300 pt-4">
                <Link to={"/"}>
                  <a
                    ...
                    className={`${
                      location.pathname === "/"
                        ? "bg-slate-200 text-slate-700 duration-200"
                        : "bg-white"
                    } group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-slate-200 hover:text-gray-700 transition-all ease-linear`}
                  >
                    <div
                      className="tooltip tooltip-right uppercase"
