    ...
    <Menu as="div" className="z-50">
      ...
      <Transition appear show={guardarDatosModal} as={Fragment}>
        <Dialog
          ...
          onClose={closeModalGuardarDatos}
        >
          <Transition.Child
            as={Fragment}
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-1/3  p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="flex gap-5 items-center justify-center my-6">
                  <button
                    onClick={() => onSubmit()}
                    className="bg-green-500/40 py-3 px-5 rounded-xl text-green-800  font-semibold flex justify-between gap-2 items-center w-full"
                  >
                    GUARDAR LOS DATOS{" "}
                    <svg
                  ...
                  <button
                    onClick={() => closeModalGuardarDatos()}
                    className="bg-red-500/20 py-3 px-5 rounded-xl text-red-700  font-semibold flex justify-between gap-2 items-center w-full"
                  >
                    CERRAR VENTANA{" "}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
